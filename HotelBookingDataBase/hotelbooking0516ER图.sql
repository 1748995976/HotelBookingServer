...
CREATE TABLE `hotel_evaluation`  (
  ...
  INDEX `foreignkey_2`(`hotelId`, `eid`) USING BTREE,
  INDEX `foreignkey_3`(`account`) USING BTREE,
  CONSTRAINT `foreignkey_1` FOREIGN KEY (`hotelId`) REFERENCES `hotels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `foreignkey_2` FOREIGN KEY (`hotelId`, `eid`) REFERENCES `hotel_room` (`hotelId`, `eid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `foreignkey_3` FOREIGN KEY (`account`) REFERENCES `user_account_pwd` (`account`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `hotel_room`  (
  ...
  INDEX `hotelId`(`hotelId`, `eid`) USING BTREE,
  CONSTRAINT `foreignkey_4` FOREIGN KEY (`hotelId`) REFERENCES `hotels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `hotel_service`  (
  ...
  CONSTRAINT `foreignkey_5` FOREIGN KEY (`hotelId`) REFERENCES `hotels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `hotels`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `foreignkey_6`(`adcode`) USING BTREE,
  CONSTRAINT `foreignkey_6` FOREIGN KEY (`adcode`) REFERENCES `adcode_moreinfo` (`adcode`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `room_state`  (
  ...
  INDEX `foreignkey_8`(`hotelId`, `eid`) USING BTREE,
  CONSTRAINT `foreignkey_7` FOREIGN KEY (`hotelId`) REFERENCES `hotels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `foreignkey_8` FOREIGN KEY (`hotelId`, `eid`) REFERENCES `hotel_room` (`hotelId`, `eid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_fav_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `foreignkey_9`(`userId`) USING BTREE,
  INDEX `foreignkey_10`(`hotelsId`) USING BTREE,
  CONSTRAINT `foreignkey_10` FOREIGN KEY (`hotelsId`) REFERENCES `hotels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `foreignkey_9` FOREIGN KEY (`userId`) REFERENCES `user_account_pwd` (`account`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_history_order`  (
  ...
  INDEX `foreignkey_11`(`account`) USING BTREE,
  INDEX `foreignkey_13`(`hotelId`, `eid`) USING BTREE,
  CONSTRAINT `foreignkey_11` FOREIGN KEY (`account`) REFERENCES `user_account_pwd` (`account`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `foreignkey_12` FOREIGN KEY (`hotelId`) REFERENCES `hotels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `foreignkey_13` FOREIGN KEY (`hotelId`, `eid`) REFERENCES `hotel_room` (`hotelId`, `eid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `user_history_order` VALUES ('111111202151416632308', '111111', '9', '2', 1, 2, '2 ', '2021-05-20', '2021-05-21', 3, '性能测试', '1234', '性能测试', 1, '2021-05-19 18:00:00', '2021-05-14 16:06:32');
INSERT INTO `user_history_order` VALUES ('111111202158132729385', '111111', '9', '2', 1, 2, '2 ', '2021-05-20', '2021-05-21', 3, '小王', '12315251534', '下午四点之前', 1, '2021-05-19 18:00:00', '2021-05-08 13:27:29');
...
CREATE TABLE `user_info`  (
  ...
  PRIMARY KEY (`account`) USING BTREE,
  CONSTRAINT `foreignkey_14` FOREIGN KEY (`account`) REFERENCES `user_account_pwd` (`account`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_lived_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `foreignkey_15`(`hotelsId`) USING BTREE,
  INDEX `foreignkey_16`(`userId`) USING BTREE,
  CONSTRAINT `foreignkey_15` FOREIGN KEY (`hotelsId`) REFERENCES `hotels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `foreignkey_16` FOREIGN KEY (`userId`) REFERENCES `user_account_pwd` (`account`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
